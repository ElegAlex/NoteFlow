...
|---|---|---|---|
|1.7|2025-12-05|Product Team|Actif - Métriques corrigées (75% global, 322 pts)|
...
**Critères d'acceptation**:
- [ ] AC1: Drag d'une note vers un autre dossier
- [ ] AC2: Drag d'un dossier vers un autre dossier (nested)
- [ ] AC3: Indicateur visuel de drop zone
- [ ] AC4: Impossible de dropper un dossier dans lui-même
- [ ] AC5: Mise à jour position pour tri personnalisé
...
**Critères d'acceptation**:
- [ ] AC1: Connexion WebSocket établie à l'ouverture d'une note
- [ ] AC2: Authentification JWT vérifiée côté serveur
- [ ] AC3: Reconnexion automatique en cas de déconnexion
- [ ] AC4: Sync initial du document Y.Doc

**Tâches techniques**:
```
[ ] TASK-029-1: Configurer serveur Hocuspocus (5 pts)
    Fichier: apps/api/src/infrastructure/websocket/hocuspocus.ts

[ ] TASK-029-2: Implémenter hook onAuthenticate (3 pts)
[ ] TASK-029-3: Implémenter Database extension (fetch/store) (3 pts)
[ ] TASK-029-4: Créer CollaborationProvider React (3 pts)
```
...
**Critères d'acceptation**:
- [ ] AC1: Indicateur vert "Connecté"
- [ ] AC2: Indicateur jaune "Synchronisation..."
- [ ] AC3: Indicateur rouge "Déconnecté"
- [ ] AC4: Tooltip avec détails

**Tâches techniques**:
```
[ ] TASK-030-1: Créer composant ConnectionStatus (3 pts)
```
...
**Critères d'acceptation**:
- [ ] AC1: Avatars des collaborateurs affichés
- [ ] AC2: Couleur unique par utilisateur
- [ ] AC3: Tooltip avec nom
- [ ] AC4: Compteur si > 5 collaborateurs

**Tâches techniques**:
```
[ ] TASK-031-1: Créer composant CollaboratorAvatars (3 pts)
[ ] TASK-031-2: Implémenter generateUserColor() (1 pt)
[ ] TASK-031-3: Hook useCollaboration pour awareness (2 pts)
```
...
**Critères d'acceptation**:
- [ ] AC1: Curseur coloré visible pour chaque collaborateur
- [ ] AC2: Nom affiché à côté du curseur
- [ ] AC3: Sélection visible (highlight de la même couleur)
- [ ] AC4: Mise à jour fluide (pas de saccades)

**Tâches techniques**:
```
[ ] TASK-032-1: Configurer CollaborationCursor TipTap extension (3 pts)
[ ] TASK-032-2: Styles CSS pour curseurs (2 pts)
[ ] TASK-032-3: Optimiser awareness throttling (2 pts)
```
...
**Critères d'acceptation**:
- [ ] AC1: Y.Doc sauvegardé 1s après dernière modification
- [ ] AC2: Contenu Markdown extrait et stocké aussi
- [ ] AC3: Chargement initial depuis Y.Doc si existant
- [ ] AC4: Migration contenu existant vers Y.Doc

**Tâches techniques**:
```
[ ] TASK-033-1: Ajouter colonne ydoc (bytea) au modèle Note (1 pt)
[ ] TASK-033-2: Implémenter initializeYDoc() (2 pts)
[ ] TASK-033-3: Implémenter extractContentFromYDoc() (2 pts)
[ ] TASK-033-4: Créer migration pour notes existantes (3 pts)
```
...
**Critères d'acceptation**:
- [ ] AC1: Vérification permissions dans onAuthenticate
- [ ] AC2: Flag canWrite passé au client
- [ ] AC3: Éditeur en mode readOnly si pas de write
- [ ] AC4: Sync des modifications toujours actif
...
**Critères d'acceptation**:
- [ ] AC1: Édition continue possible hors-ligne (CRDT local)
- [ ] AC2: Merge automatique à la reconnexion
- [ ] AC3: Notification utilisateur du mode dégradé
- [ ] AC4: Pas de perte de données
...
|--------|--------|--------|
| ✅ DONE | 1 | 13 pts |
| 🔄 IN_PROGRESS | 3 | 16 pts |
| ⏳ TODO | 3 | 18 pts |
| **Progression** | **45%** | **~21/47 pts** |

**Implémenté**:
- Serveur Yjs dans `apps/yjs-server/`
- Hook `useCollaboration` existe
- Colonne `yjsState` dans schéma Prisma
...
**Critères d'acceptation**:
- [ ] AC1: Popup suggestion après `[[`
- [ ] AC2: Recherche fuzzy dans titres de notes
- [ ] AC3: Notes récentes si pas de query
- [ ] AC4: Navigation clavier (arrows + enter)
- [ ] AC5: Affichage chemin dossier

**Tâches techniques**:
```
[ ] TASK-037-1: Créer WikiLinkSuggestion component (3 pts)
[ ] TASK-037-2: Intégrer tiptap-suggestion + tippy (2 pts)
[ ] TASK-037-3: Créer endpoint GET /api/v1/notes/search (3 pts)
```
...
**Critères d'acceptation**:
- [ ] AC1: Clic sur lien cassé propose de créer la note
- [ ] AC2: Titre pré-rempli depuis le lien
- [ ] AC3: Dossier sélectionnable
...
**Critères d'acceptation**:
- [ ] AC1: `![[note]]` affiche le contenu inline
- [ ] AC2: `![[note#section]]` affiche section spécifique
- [ ] AC3: Cadre distinctif pour embed
- [ ] AC4: Lien vers note source
...
| ✅ DONE | 2 | 16 pts |
| ⏳ TODO | 3 | 13 pts |
| **Progression** | **55%** | **16/29 pts** |

**Implémenté**: WikiLink extension, BacklinksPanel, modèle Link
**À faire**: Autocomplétion, création depuis lien cassé, embed
...
**Critères d'acceptation**:
- [ ] AC1: Route `/` affiche homepage après login
- [ ] AC2: Message de bienvenue personnalisé
- [ ] AC3: Date du jour formatée
- [ ] AC4: Layout grid responsive
...
**Critères d'acceptation**:
- [ ] AC1: Liste des 10 dernières notes modifiées
- [ ] AC2: Titre, dossier, date relative
- [ ] AC3: Clic navigue vers la note
- [ ] AC4: Lien "Voir tout"

**Tâches techniques**:
```
[ ] TASK-042-1: Créer endpoint GET /api/v1/notes/recent (2 pts)
[ ] TASK-042-2: Créer composant RecentNotesWidget (3 pts)
```
...
**Critères d'acceptation**:
- [ ] AC1: Calendrier mensuel affiché
- [ ] AC2: Navigation mois précédent/suivant
- [ ] AC3: Événements extraits du frontmatter (date, due, deadline)
- [ ] AC4: Points colorés sur les jours avec événements
- [ ] AC5: Liste événements à venir

**Tâches techniques**:
```
[ ] TASK-043-1: Créer CalendarService.getEvents() (3 pts)
[ ] TASK-043-2: Créer endpoint GET /api/v1/calendar/events (2 pts)
[ ] TASK-043-3: Créer composant CalendarWidget (5 pts)
[ ] TASK-043-4: Créer composant CalendarGrid (3 pts)
```
...
**Critères d'acceptation**:
- [ ] AC1: Liste des notes avec `pinned: true` en frontmatter
- [ ] AC2: Icône épingle distinctive
- [ ] AC3: Max 5 notes affichées
...
**Critères d'acceptation**:
- [ ] AC1: Banner en haut de page
- [ ] AC2: Types: info, warning, danger
- [ ] AC3: Dismissable par utilisateur
- [ ] AC4: Admin peut créer/modifier
...
**Critères d'acceptation**:
- [ ] AC1: Input de recherche centré
- [ ] AC2: Raccourci `Cmd/Ctrl+K` focus
- [ ] AC3: Suggestions au typing
- [ ] AC4: Enter navigue vers résultats
...
| 🔄 IN_PROGRESS | 1 | 5 pts |
| ⏳ TODO | 4 | 24 pts |
| **Progression** | **20%** | **~7/34 pts** |

**Implémenté**: HomePage.tsx existe, route `/api/v1/notes/recent`
**À faire**: Widgets (calendrier, docs épinglés, annonces, recherche)
...
- [ ] AC2: Activer/désactiver compte
- [ ] AC3: Changer rôle
- [ ] AC4: Voir dernière connexion
...
| ✅ DONE | 6 | 37 pts |
| ⏳ TODO | 1 | 5 pts |
| **Progression** | **88%** | **37/42 pts** |

**Implémenté**: Login/Logout, protection routes, rôles, permissions RBAC
**À faire**: Interface admin utilisateurs complète (AdminPage existe mais partielle)
...
│  EPIC-05 Collaboration:   ██████████░░░░░░░░░░░░ 45%  (~21/47 pts)         │
...
*Dernière mise à jour: 2025-12-05 — Sprint 4 Gestion Images terminé (100%)*
